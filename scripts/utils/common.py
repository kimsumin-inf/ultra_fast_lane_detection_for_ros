...
def get_args():
    ...
    parser.add_argument('--config',default="/home/sumin/catkin_ws/src/lane_detection/scripts/configs/tusimple.py", help = 'path to config file')
    ...
    parser.add_argument('--test_model', default = "/home/sumin/catkin_ws/src/lane_detection/scripts/tusimple_18.pth", type = str)
...
def merge_config():
    ...
    cfg = Config.fromfile("/home/sumin/catkin_ws/src/lane_detection/scripts/configs/tusimple.py")
